...
public class TimeEntryApiTest {
    ...
    public void testCreate() throws Exception {
        ResponseEntity<String> createResponse = this.restTemplate.postForEntity("/time-entries", timeEntry, String.class);
    ...
    public void testList() throws Exception {
        ...
        ResponseEntity<String> listResponse = this.restTemplate.getForEntity("/time-entries", String.class);
    ...
    public void testUpdate() throws Exception {
        ...
        ResponseEntity<String> updateResponse = this.restTemplate.exchange("/time-entries/" + id, HttpMethod.PUT, new HttpEntity<>(updatedTimeEntry, null), String.class);
    ...
    public void testDelete() throws Exception {
        ...
        ResponseEntity<String> deleteResponse = this.restTemplate.exchange("/time-entries/" + id, HttpMethod.DELETE, null, String.class);
